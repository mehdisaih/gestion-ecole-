...
Route::controller(DepartmentController::class)->group(function () {
    Route::get('department/list', 'listDepartment')->middleware('auth')->name('department/list');//list department
    Route::get('department/add/page', 'indexDepartment')->middleware('auth')->name('department/add/page'); // page add department
    Route::post('department/add/save', 'departementSave')->name('department/add/save');
...
Route::controller(SubjectsController::class)->group( function () {
    Route::get('Subjects/list', 'listSubjects')->middleware('auth')->name('Subjects/list');
    Route::get('Subjects/add', 'AddSubjects')->middleware('auth')->name('Subjects/add');
    Route::get('Subjects/edit', 'EditSubjects')->middleware('auth')->name('Subjects/edit');
